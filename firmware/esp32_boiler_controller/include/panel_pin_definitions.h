/**
 * @file panel_pin_definitions.h
 * @brief Pin definitions for panel coprocessor (ESP32 DevKit at boiler)
 *
 ...
 *
 * Legacy alias: c3_pin_definitions.h includes this file (C3 naming was from
 * earlier XIAO ESP32-C3 design; hardware is now ESP32 DevKit).
 */

#ifndef PANEL_PIN_DEFINITIONS_H
#define PANEL_PIN_DEFINITIONS_H
...
// ============================================================================
// PIN ASSIGNMENT SUMMARY — Panel ESP32 DevKit (boiler)
// ============================================================================
//
//  GPIO   Function
//  ----   --------
